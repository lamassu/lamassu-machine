...
id003.on('billsAccepted', function () { console.log('Bill accepted') })
id003.on('billsRead', function (data) { console.log('Bill read') })
id003.on('billsValid', function () { console.log('Bill valid') })
id003.on('billsRejected', function () { console.log('Bill rejected') })
