...
function repeatCallback (options, _realCallback) {
  var realCallback = function (err, res, data) {
    delayCount = 0
    _realCallback(err, res, data)
  }
...
function request (options, callback) {
  ...
  req.on('response', function (res) {
    if (res.statusCode < 200 || res.statusCode >= 300) return _callback(null, res)
