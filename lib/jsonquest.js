...
function _request (options, callback) {
  ...
  console.log('DEBUG43: %s', options.path)
  ...
  if (!options.deviceId) {
    console.log('DEBUG22')
    if (options.body) req.end(encoder.stringify(options.body))
    console.log('DEBUG23')
  }
  ...
  req.on('response', function (res) {
    ...
    console.log('DEBUG27: %s, %s', res.peerDeviceId, peerDeviceId)
