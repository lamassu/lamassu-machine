...
//    this._verifyManifest.bind(this),
//    this._verifyHashList.bind(this),
//    this._verifyIntegrity.bind(this),
//    this._inspectHashList.bind(this)
  ], function(err) {
    if (err) {
