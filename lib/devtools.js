...
DevTools.prototype.run = function run () {
  ...
  const uiToolsPage = fs.readFileSync(path.resolve(__dirname, '../ui/html/ui-tools.html'))

  if (!uiToolsPage) console.log(`Error reading ${path.resolve(__dirname, '../ui/html/ui-tools.html')}`)
