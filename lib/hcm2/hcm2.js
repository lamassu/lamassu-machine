...
Hcm2.prototype.dispenseByRoom = function dispenseByRoom (bills) {
  ...
  .then(result => { // Passthrough potential errors since they'll be handled in a parent function
    ...
    // Bills rejected
    if (result.StackedNotesEscrow !== '0')
      return this.retractEscrow().catch(console.log).then(() => result)
    // Note shortage
    if (result.commonErrorCode === '93' && result.commonErrorCodeDetail === '010000')
      return result
...
Hcm2.prototype.dispense = function dispense (notes) {
  return this.dispenseByRoom(notes)
    .then(res => ({
      ...
      // TODO(siiky): Get number of rejected bills -- e.g.:
      // RequestCountRoom2A: '2',
      // RequestCountRoom3A: '2',
      // RequestCountRoom4A: '1',
      // RequestCountRoom5A: '1',
      // DispenseCountRoom2A: '2',
      // DispenseCountRoom3A: '2',
      // DispenseCountRoom4A: '1',
      // DispenseCountRoom5A: '1',
      // TotalStackedNotesUpRejBox: '42',
      // StackedNotesCashSlot: '6',
      // StackedNotesEscrow: '9',
      // StackedNotesURJB: '0',
      // StackedNotes1A: '0',
      // StackedNotes2A: '0',
      // StackedNotes3A: '0',
      ...
      // FedNotes4A: '1',
      // FedNotes5A: '1',
      // StackedNotesByDenomAndDest: '3,Cash Slot,2,4,Cash Slot,2,5,Cash Slot,1,6,Cash Slot,1',
      // RejectedNotesByDenomAndSource: '3,2A,9',
      // RejectedNotesByDenomAndDest: '4,Escrow,3,5,Escrow,3,6,Escrow,3',
      value: _.map(
