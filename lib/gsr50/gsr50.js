  ...
  return this.getDeviceCashUnits()
    .then(res => ({
      ...
      cassette1: {
        ...
        // Count: _.find(it => it.Number === 2 && it.Position === CASH_UNIT_POSITIONS.Stacker1R, res.Units).Count,
        Currency: {
          CurrencyCode: this.fiatCode,
      ...
      cassette2: {
        ...
        // Count: _.find(it => it.Number === 4 && it.Position === CASH_UNIT_POSITIONS.Stacker2F, res.Units).Count,
        Currency: {
          CurrencyCode: this.fiatCode,
      ...
      cassette3: {
        ...
        // Count: _.find(it => it.Number === 6 && it.Position === CASH_UNIT_POSITIONS.Stacker2R, res.Units).Count,
        Currency: {
          CurrencyCode: this.fiatCode,
      ...
      cassette4: {
        ...
        // Count: _.find(it => it.Number === 7 && it.Position === CASH_UNIT_POSITIONS.Stacker3F, res.Units).Count,
        Currency: {
          CurrencyCode: this.fiatCode,
