  ...
  return this.getDeviceCashUnits()
    .then(res => ({
      ...
      cassette2: {
        ...
        Count: _.find(it => it.Number === 3 && it.Position === CASH_UNIT_POSITIONS.Stacker2F, res.Units).Count,
        Currency: {
          CurrencyCode: this.fiatCode,
          Denomination: 1.0
        }
      ...
      cassette3: {
        ...
        Count: _.find(it => it.Number === 5 && it.Position === CASH_UNIT_POSITIONS.Stacker3F, res.Units).Count,
        Currency: {
          CurrencyCode: this.fiatCode,
          Denomination: 1.0
        }
