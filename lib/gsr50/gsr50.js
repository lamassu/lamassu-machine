...
Gsr50.prototype.resetDeviceState = function resetDeviceState (cb, cassettes, stackers) {
...
// enable actually does a reset of cash units to handle the "manipulated" flag
Gsr50.prototype.enable = function enable (cassettes, stackers) {
  return this.getDeviceState()
    .then(() => this.getDeviceCashUnits())
    .then(() => this.setDeviceCashUnits(cassettes, stackers))
}
...
Gsr50.prototype.updateCounts = function updateCounts (newCounts) {
  ...
  console.log('GSR50: ', JSON.stringify(this.cassettes, this.stackers))
