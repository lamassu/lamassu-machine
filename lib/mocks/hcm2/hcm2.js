...
Hcm2.prototype.getFirmwareVersion = function getFirmwareVersion () {
  return responses.getFirmwareVersion().then(res => JSON.parse(res.body.body).result)
}

Hcm2.prototype.getInfo = function getInfo () {
  return responses.getInfo().then(res => JSON.parse(res.body.body).result)
  .then(body => {
...
Hcm2.prototype.getBanknoteInfo = function getBanknoteInfo (cassettes = []) {
  return responses.getBanknoteInfo().then(res => JSON.parse(res.body.body).result)
  .then(body => {
...
Hcm2.prototype.setDenomination = function setDenomination () {
  return responses.setDenomination().then(res => JSON.parse(res.body.body).result)
}

Hcm2.prototype.setInfo = function setInfo () {
  const params = null // TODO
  return responses.setInfo(params).then(res => JSON.parse(res.body.body).result)
}

Hcm2.prototype.reset = function reset (mode) {
  return responses.reset().then(res => JSON.parse(res.body.body).result)
}

Hcm2.prototype.openCloseShutter = function openCloseShutter (open) {
  return responses.openCloseShutter().then(res => JSON.parse(res.body.body).result)
}
...
Hcm2.prototype.deposit = function deposit (bills) {
  const params = null // TODO
  return responses.deposit(params).then(res => JSON.parse(res.body.body).result)
}

Hcm2.prototype.cashRollback = function cashRollback () {
  return responses.cashRollback().then(res => JSON.parse(res.body.body).result)
}

Hcm2.prototype.dispenseByRoom = function dispenseByRoom (bills) {
  const params = null // TODO
  return responses.dispenseByRoom(params).then(res => JSON.parse(res.body.body).result)
}
