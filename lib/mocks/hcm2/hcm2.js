...
Hcm2.prototype.dispense = function dispense (notes) {
  return this.dispenseByRoom(notes)
    .then(_res => {
      ...
      if (_.any(it => it === 'true', _.pick(['commonCassette1Error', 'commonCassette2Error', 'commonCassette3Error', 'commonCassette4Error', 'commonCassette5Error'], errors)) || errors.error !== 'OK') {
        console.log('errors', errors)
        response.error = new Error(`Dispensing, code: ${errors.responseCode}, description: ${errors.responseCodeDescription}`)
      }
