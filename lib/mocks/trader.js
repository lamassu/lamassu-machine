...
var Trader = function () {
  ...
  this.zeroConfLimits = this.buildZeroConfLimits(Object.keys(Tx.coins))
...
Trader.prototype.buildZeroConfLimits = function buildZeroConfLimits (cryptoCodes) {
  const zeroConfLimits = {}
  _.forEach(cryptoCode => { zeroConfLimits[cryptoCode] = 20 }, cryptoCodes)
