...
Id003Rs232.prototype.send = function send (command) {
  ...
  console.log('DEBUG rs232 command: %s', command)
...
Id003Rs232.prototype._process = function _process (data) {
  console.log('DEBUG16: %s', data.toString('hex'))
  this.buf = Buffer.concat([this.buf, data])
  this.buf = this._acquireSync(this.buf)

  console.log('DEBUG17', this.buf.toString('hex'))
  ...
  console.log('DEBUG18: %s, %s', packet.toString('hex'), this.buf.toString('hex'))
