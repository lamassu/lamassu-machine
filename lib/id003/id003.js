...
Id003.prototype.hasShutter = () => false
...
Id003.prototype._run = function _run (cb) {
  ...
  this.id003Fsm.on('billsAccepted', function () {
    self.emit('billsAccepted')
  })

  this.id003Fsm.on('billsRead', function (data) {
  ...
  this.id003Fsm.on('billsValid', function () {
    self.emit('billsValid')
  })

  this.id003Fsm.on('billsRejected', function () {
