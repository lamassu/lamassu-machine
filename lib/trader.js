...
const Trader = function (protocol, clientCert, connectionInfo, dataPath, cryptomatModel) {
  if (!(this instanceof Trader)) return new Trader(protocol, clientCert, connectionInfo, dataPath, cryptomatModel)
  ...
  this.cryptomatModel = cryptomatModel
...
Trader.prototype.poll = function poll () {
  ...
  const path = '/poll?state=' + stateRec.state + '&model=' + this.cryptomatModel + '&version=' + version + '&idle=' + stateRec.isIdle + '&pid=' + pid + '&sn=' + serialNumber.toString()
  serialNumber++
