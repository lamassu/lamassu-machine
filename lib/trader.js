...
Trader.prototype.calculateTxLimit = function calculateTxLimit (txLimit) {
  if (this.hardLimitVerificationActive &&
     this.hardLimitVerificationThreshold) {
    return BN(this.hardLimitVerificationThreshold)
  }
  return BN(txLimit || Infinity)
}
...
Trader.prototype.pollHandler = function pollHandler (res) {
  ...
  this.hardLimitVerificationThreshold = res.hardLimitVerificationThreshold
  this.txLimit = this.calculateTxLimit(res.txLimit)
