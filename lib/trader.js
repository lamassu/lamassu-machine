...
const Trader = function (protocol, clientCert, connectionInfo, dataPath, relayedModel) {
  ...
  this.areThereAvailableCoupons = null
...
Trader.prototype.verifyCoupon = function verifyCoupon (code, tx) {
  return this.request({
    path: '/verify_coupon',
    method: 'POST',
...
Trader.prototype.pollHandler = function pollHandler (res) {
  ...
  this.areThereAvailableCoupons = res.areThereAvailableCoupons
