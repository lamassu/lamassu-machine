...
Trader.prototype.getExternalCompliance = function getExternalCompliance (customerId, triggerId) {
  return this.request({
    path: `/customer/external?customer=${customerId}&trigger=${triggerId}`,
    method: 'get'
  })
    .then(r => r.body)
}
