...
Brain.prototype._processReal = function _processReal (req) {
  ...
  switch (req.button) {
    ...
    case 'permissionSmsCompliance':
      console.log('SETTING this.permissionsGiven.sms SMS TO TRUE')
...
Brain.prototype._billRead = function _billRead (data) {
  console.log('[DEBUG]: Entered _billRead with data', data)
  const billValidator = this.billValidator
...
Brain.prototype.runComplianceTiers = function (nonCompliantTiers) {
  ...
  console.log('[DEBUG]: nonCompliantTiers', nonCompliantTiers)
  console.log('[DEBUG]: this.permissionsGiven', this.permissionsGiven)
  console.log('[DEBUG]: isCashIn', isCashIn)
  console.log('[DEBUG]: smsScreen', smsScreen)
  console.log('[DEBUG]: idScreen', idScreen)
  console.log('[DEBUG]: photoScreen', photoScreen)
  console.log('[DEBUG]: usSsnScreen', usSsnScreen)
  console.log('[DEBUG]: customScreen', customScreen)

  if (smsScreen || idScreen || photoScreen || usSsnScreen || customScreen) {
    console.log('[DEBUG]: Transitioning to a verification string with tier', tier)
    console.log('[DEBUG]: this.permissionsGiven', this.permissionsGiven)
    return this.transitionToVerificationScreen(tier)
  }

  console.log('[DEBUG]: Running compliance tier', tier)
  console.log('[DEBUG]: this.permissionsGiven', this.permissionsGiven)
...
Brain.prototype.fastUpdateTx = function fastUpdateTx (updateTx) {
  console.log('[DEBUG]: Entered fastUpdateTx with this.bill value', this.bill)
...
Brain.prototype.insertBill = function insertBill (bill) {
  console.log('[DEBUG]: Entered insertBill with bill', bill)
