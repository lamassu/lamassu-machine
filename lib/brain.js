...
Brain.prototype.startScreen = function startScreen (compliant) {
  console.log('billValidator lowest bill', this.billValidator.lowestBill(this.tx.fiat))
  if (this.trader.smsVerificationActive && 
      this.billValidator.lowestBill(this.tx.fiat).eq(this.trader.smsVerificationThreshold) &&
      !compliant) {
