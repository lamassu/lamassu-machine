...
Brain.prototype._chooseCoin = function _chooseCoin (coinCode) {
...
Brain.prototype.sendRates = function sendRates () {
  var coinCode = this.coinCode
  if (!coinCode) return

  var rec = {
    currency: this.currency,
    rates: {
      rates: this.trader.rates[coinCode],
      coinCode: coinCode
    },
...
Brain.prototype.truncateCrypto = function truncateCrypto (cryptoAtoms) {
  var scale = this.trader.coins[this.coinCode].displayScale

  // Give it an extra 3 decimals of precision
  var scaleFactor = new BigNumber(10).pow(scale - 3)
...
Brain.prototype._createPendingTransaction = function _createPendingTransaction (bill) {
  ...
  var exchangeRate = this.trader.rates[this.coinCode].cashIn
...
Brain.prototype._fiatButton = function _fiatButton (data) {
  ...
  var rate = this.trader.rates[this.coinCode].cashOut
