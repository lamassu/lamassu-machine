...
Brain.prototype._uiCredit = function _uiCredit () {
  ...
  return {
    ...
    cryptoUnit: this.getCryptoUnit(tx)
  }
}

Brain.prototype.getCryptoUnit = function getCryptoUnits (tx) {
  const unitSelected = _.get('cryptoUnits')(_.find(['cryptoCode', tx.cryptoCode], this.trader.coins))
  const units = coinUtils.getCryptoCurrency(tx.cryptoCode).units
  return _.get(unitSelected)(units)
}
