...
Brain.prototype.isTierCompliant = function isTierCompliant (tier) {
  ...
  switch (tier) {
    ...
    case 'hardLimit':
      /*
       * I think we should ALWAYS return true
       * because hardLimit is already checked by
       * the Brain.hardLimit function which returns
       * the threshold accordingly with the current tx amount.
       * Currently this is always being picked
       * by nonCompliantTiers function
       */
      // return false
      return true
    case 'idCardData':
