...
Brain.prototype.smsFlowHandleReturnState = function smsFlowHandleReturnState () {
  this.browser().send({
    ...
    automaticPrint: this.trader.automaticReceiptPrintActive
  })
...
Brain.prototype._cashInComplete = function _cashInComplete () {
  ...
  if (this.trader.automaticReceiptPrintActive) this._startPrintReceipt()
...
Brain.prototype._startPrintReceipt = function _startPrintReceipt () {
  this.browser().send({ receiptStatus: 'printing', automaticPrint: this.trader.automaticReceiptPrintActive })
  this._printReceipt()
    .then(() => this.browser().send({ receiptStatus: 'success', automaticPrint: this.trader.automaticReceiptPrintActive }))
    .catch(() => {
      this.browser().send({ receiptStatus: 'failed', automaticPrint: this.trader.automaticReceiptPrintActive })
      setTimeout(() => {
        this.browser().send({ receiptStatus: 'available', automaticPrint: this.trader.automaticReceiptPrintActive })
      }, 2500)
    })
}
