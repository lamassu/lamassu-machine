  ...
  if (!appState) {
    ...
    switch (machineState) {
      ...
      case 'photoCardScanFailed':
        appState = 'id_photo_scan_failed'
        break
      case 'photoCardVerificationFailed':
        appState = 'id_photo_verification_failed'
        break
    }
  }
  ...
  if (!appState) {
    ...
    switch (machineState) {
      case 'takeFacephoto':
        ...
        break
      case 'retryTakeFacephoto':
        appState = 'scan_face_photo_retry'
        break
      case 'authorizing':
        appState = 'verifying_face_photo'
        break
      case 'facephotoFailed':
        appState = 'scan_face_photo_failed'
        break
