...
Brain.prototype.startScreen = function startScreen (compliant) {
  // if (this.trader.smsVerificationActive && !compliant) {
...
Brain.prototype._billRead = function _billRead (data) {
  ...
  // TODO: Check if threshold is 0 and popup the sms screen without bill insertion
  if(this.trader.smsVerificationActive && fiat.gte(this.trader.smsVerificationThreshold)) {
    this.browser().send({
