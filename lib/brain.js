...
Brain.prototype.idCardStillsCallback = function idCardStillsCallback (failedScansTmpdirs) {
  ...
  .then(_.flow(
    _.flatten,
    failedScans => _.chunk(failedScans, _.round(_.size(failedScans)/6)),
...
Brain.prototype.enableBillValidator = function enableBillValidator () {
  ...
  this.billValidator.enable(this.trader.cassettes, this.trader.stackers)
}
...
Brain.prototype.maintenanceRestart = function maintenanceRestart () {
  /* TODO */
}
