...
var Brain = function (config) {
  ...
  this.credit = {fiat: 0, cryptoUnits: 0, lastBill: null}
  this.creditConfirmed = {fiat: 0, cryptoUnits: 0}
  this.fiatTx = null
  this.pending = null
...
Brain.prototype._billValid = function _billValid () {
  ...
  this.credit.cryptoUnits += pending.cryptoUnits
  ...
  this.trader.trade(tradeRec, function (err) {
    if (!err) {
      ...
      self.creditConfirmed.cryptoUnits += pending.cryptoUnits
    }
  })
...
Brain.prototype._uiCredit = function _uiCredit () {
  ...
  if (this.pending) {
    var pending = this.pending
    fiat += pending.fiat
    cryptoUnits = this.truncateCrypto(cryptoUnits + pending.cryptoUnits)
...
Brain.prototype._resetState = function _resetState () {
  ...
  this.cryptoAddress = null
  this.credit.fiat = 0
  this.credit.cryptoUnits = 0
  this.credit.lastBill = null
  this.creditConfirmed.fiat = 0
  this.creditConfirmed.cryptoUnits = 0
  this.pending = null
}
