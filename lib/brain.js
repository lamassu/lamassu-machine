...
var STATIC_STATES = ['idle', 'dualIdle', 'networkDown', 'unpaired'];
...
Brain.prototype._startIdScan = function _startIdScan() {
  ...
  this.scanner.scanPDF417(function (err, result) {
    ...
    if (err) throw err;
    var freshState = self.trader.sessionId === sessionId &&
...
Brain.prototype._hasLowCash = function _hasLowCash() {
  return _.max(this.trader.cartridges, 'count') > 0;
};

Brain.prototype._lowCash = function _lowCash() {
  var self = this;
...
Brain.prototype._chooseFiat = function _chooseFiat() {
  if (this._hasLowCash()) return this._lowCash();
  var sessionId = this.trader.sessionId;
  this.fiatTx = {
    fiat: 0,
    satoshis: 0,
