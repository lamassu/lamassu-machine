...
Brain.prototype.setBillValidator = function setBillValidator(bv) {
	this.billValidator = bv;
};
...
Brain.prototype.setBrowser = function setBrowser(br) {
	this.browser = br;
};
...
Brain.prototype._initBrowserEvents = function _initBrowserEvents() {
  ...
  this.browser.on('messageError', function(err) {
