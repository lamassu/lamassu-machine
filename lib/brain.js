...
Brain.prototype._connectedBrowser = function _connectedBrowser () {
  ...
  var cryptoCode = this.trader.coins.length === 1
  ? this.trader.coins[0]
  : null
...
Brain.prototype._chooseCoinScreen = function _chooseCoinsScreen (localeInfo, cartridges) {
  console.log('DEBUG20')
  console.log(this.trader.coins)
  if (this.trader.coins.length === 1) {
    this.browser().send({localeInfo: localeInfo, cartridges: cartridges})
    return this._chooseCoin(this.trader.coins[0])
  }

  this._transitionState('chooseCoin', {localeInfo: localeInfo, cartridges: cartridges})
}
