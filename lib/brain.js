...
const Brain = function (config) {
  ...
  this.scannerTimeout = null // Change this config value because of the internal timeout on the genmega SDK
...
Brain.prototype.scanPDF = function scanPDF () {
  ...
  // Change the LED code to support genmega
  this.scanBayLightOn()
