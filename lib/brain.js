...
Brain.prototype._initBillValidatorEvents = function _initBillValidatorEvents () {
  ...
  billValidator.on('stackerInsert', function () { self._stackerInsert() })
...
Brain.prototype._stackerOpen = function _stackerOpen () {
  return this.trader.cashboxRemoved()
}

Brain.prototype._stackerInsert = function _stackerInsert () {
  return this.trader.cashboxInserted()
}
