...
Brain.prototype.getHardLimitThreshold = function getHardLimitThreshold (trader, hasFFcamera) {
  const shouldUseCameraThreshold = !hasFFcamera && trader.frontCameraVerificationActive && !_.isNil(trader.frontCameraVerificationThreshold)
  const thresholdIfNoFrontCamera = shouldUseCameraThreshold ? BN(trader.frontCameraVerificationThreshold) : BN(Infinity)
