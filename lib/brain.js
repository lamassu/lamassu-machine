...
Brain.prototype._phoneNumber = function _phoneNumber(number) {
  ...
  // TODO: use fetchPhone for redeem
...
Brain.prototype._redeemDispense = function _redeemDispense() {
  this._dispense(this.fiatTx.fiat, this.fiatTx.currencyCode);
};
