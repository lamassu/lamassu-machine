...
async.series([
  ...
  async.apply(command, 'mkdir -p /opt/apps/machine/config'),
  ...
  async.apply(command, 'cp /tmp/extract/package/hardware/' + hardwareCode + '/device_config.json /opt/apps/machine/config'),
